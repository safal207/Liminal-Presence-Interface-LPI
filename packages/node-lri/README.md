...
> **Naming update:** LPI is the canonical naming in the Node SDK. All legacy LRI exports remain available as backward-compatible aliases and emit a one-time deprecation warning on first call/instantiation. No breaking changes are introduced.
