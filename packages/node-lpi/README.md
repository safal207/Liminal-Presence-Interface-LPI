...
import { lpiMiddleware, createLCEHeader, LCE } from 'node-lpi';
...
### LTP - Liminal Trust Protocol (`node-lpi/ltp`)
...
### LSS - Liminal Session Store (`node-lpi/lss`)
...
- [GitHub Repository](https://github.com/safal207/Liminal-Presence-Interface-LPI)
